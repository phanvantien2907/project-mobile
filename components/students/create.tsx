...
export default function CreateStudent({ visible, onClose, onSuccess }: Props) {
  ...
  const onSubmit = async (data: FormData) => {
    try {
      ...
      Toast.show({
        type: "success",
        text1: "Thành công",
        text2: "Đã thêm sinh viên thành công",
      });
      onSuccess?.();
      onClose();
    } catch (e) {
  ...
  return (
    <Modal visible={visible} transparent animationType="fade">
      ...
      >
        ...
        <View className="rounded-3xl bg-brand-50 p-6 shadow-xl leading-relaxed">
