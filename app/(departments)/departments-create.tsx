...
import {
  Building2, Hash, AlignLeft, User, Phone,
...
export default function DepartmentsCreateScreen() {
  ...
  const { control, handleSubmit } = useForm<FormData>({
    defaultValues: {
      ...
      head_of_department: "", deputy_head: "",
      established_year: "", email: "", phone: "", location: "",
    },
  });
    ...
    >
      ...
      >
        ...
        <View style={{ gap: 12, marginBottom: 24 }}>
          ...
          />
          <Controller
            control={control} name="established_year"
            render={({ field: { onChange, value } }) => (
        ...
        <View style={{ gap: 12, marginBottom: 32 }}>
          <Controller
            control={control} name="head_of_department"
            render={({ field: { onChange, value } }) => (
          ...
          />
          <Controller
            control={control} name="deputy_head"
            render={({ field: { onChange, value } }) => (
